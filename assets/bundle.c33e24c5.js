! function(a) {
	...
	function l(a) {
		const o = a.id,
			i = u.get(o);
		if(i) a.isExpired ? (u.delete(o), i.isExpired = !0) : (t = a, (n = i)
			.id = t.id, n.name = t.name, n.value = t.value, n.domain = t.domain, n.hostOnly = t.hostOnly, n.path = t.path, n.expires = t.expires, n.isExpired = t.isExpired, n.secure = t.secure, n.httpOnly = t.httpOnly, n.sameSite = t.sameSite), e.add(i);
		else {
	...
	function n(a) {
		let o = !1;
		return a = (a = a.replace(/(\b)location(\b)/g, (a, i, e) => (o = !0, i + "__location" + e)))
			.replace(/postMessage\s*\(/g, a => (o = !0, a + "...(self.__set_srcWin?__set_srcWin():[]), ")), o ? a : null
	}
	...
	class n {
		...
		_getStore(a, o) {
			return this._db.transaction(a, o)
				.objectStore(a)
		}
		open(a) {
			const o = new e.a,
	...
	"onclick" in (e = self) ? function(a) {
		...
		n.h(n.c), i(12)
			.init(a, location.origin), a.__set_srcWin = function() {
				return []
			}
	}(e)
}, function(a, o, i) {
	...
	async function aa(a, o, i, e) {
		...
		if(301 === u || 302 === u || 303 === u || 307 === u || 308 === u) {
			const n = m.get("location"),
				s = n && t.k(n, o);
			if(s) {
				if("follow" === a.redirect) return ++e === H ? X("重定向太多了。。", 500) : aa(a, s, i, e);
				l("location", t.g(s))
			}
			return new Response(null, g)
		}
		const h = m.get("content-type") || "",
			[, d, j] = h.toLocaleLowerCase()
			.match(/([^;]*)(?:.*?charset=['"]?([^'"]+))?/),
			b = a.destination;
	...
	async function oa(a, o) {
		...
		try {
			...
			return console.error(a), X("他妈的，前端脚本错误，请尝试刷新！<br><pre>" + a.stack + "</pre>", 500)
		}
	}
	let ia, ea;
	async function na() {
	...
	C.addEventListener("fetch", a => {
		a.respondWith(async function(a) {
			...
			if(i === e.g || i === e.d) {
				...
				return I.index_path || (a = I.assets_cdn + "index_v3.html"), X((await fetch(a))
					.body)
			}
